import { DBUIMessagePart, DBUIMessagePartSelect } from "@/db/schema/chat"
...
export const mapDBPartToUIMessagePart = (part: DBUIMessagePartSelect): UIMessagePart<UIDataTypes, UITools> => {
  switch (part.type) {
    case "text":
      return {
        type: part.type,
